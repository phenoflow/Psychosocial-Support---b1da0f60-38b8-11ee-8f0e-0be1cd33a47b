...
(async () => {
  ...
  await fs.writeFile("psychosocial-support-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("psychosocial-support-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
